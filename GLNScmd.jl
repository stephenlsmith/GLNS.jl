...
function parse_cmd(ARGS)
    ...
    if ARGS[1] == "-help" || ARGS[1] == "--help"
        println("Usage:  GLNScmd.jl [filename] [optional flags]\n")
        ...
        println("-noise=[None, Both, Subset, Add] (default is Add)")
		println("-num_iterations=[Int]            (default set by mode. Number multiplied by # of sets)")
        println("-verbose=[0, 1, 2, 3]            (default is 3. 0 is no output, 3 is most verbose)")
